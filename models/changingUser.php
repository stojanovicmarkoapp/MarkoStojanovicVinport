    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        try{
            ...
            if($locked != null && $locked != "1"){
                $errors[]="You have not filled the field for the locked properly. Example: No";
            }
            if(count($errors)==0){
                ...
                $changingUser = changingUser($userId,$firstName,$lastName,$emailAddress,$username,$password,$roleId,$locked);
                $response = ["message"=>"You have changed an user successfully!"];
